...
let serialize_valid_session_st i p si vi st =
  ...
  match st with
   |InitiatorSentMsg1 b x ->
    A.concat (A.literal_to_labeled_bytes #isokem_global_usage #i #(readers [V p si vi]) (String "InitiatorSentMsg1"))
	      (A.concat (A.literal_to_labeled_bytes #isokem_global_usage #i #(readers [V p si vi]) (String b)) x)
   |ResponderSentMsg2 a gx gy k ->
    A.can_flow_transitive i (A.get_label isokem_key_usages k) (readers [P p]) (readers [V p si vi]);
    A.concat (A.literal_to_labeled_bytes #isokem_global_usage #i #(readers [V p si vi]) (String "ResponderSentMsg2"))
	     (A.concat (A.literal_to_labeled_bytes #isokem_global_usage #i #(readers [V p si vi]) (String a)) (A.concat gx (A.concat gy k)))
   |InitiatorSentMsg3 b gx gy k ->
    A.can_flow_transitive i (A.get_label isokem_key_usages k) (readers [P p]) (readers [V p si vi]);
    A.concat (A.literal_to_labeled_bytes #isokem_global_usage #i #(readers [V p si vi]) (String "InitiatorSentMsg3"))
	   (A.concat (A.literal_to_labeled_bytes #isokem_global_usage #i #(readers [V p si vi]) (String b)) (A.concat gx (A.concat gy k)))
   |ResponderReceivedMsg3 a gx gy k ->
    A.can_flow_transitive i (A.get_label isokem_key_usages k) (readers [P p]) (readers [V p si vi]);
    A.concat (A.literal_to_labeled_bytes #isokem_global_usage #i #(readers [V p si vi]) (String "ResponderReceivedMsg3"))
	   (A.concat (A.literal_to_labeled_bytes #isokem_global_usage #i #(readers [V p si vi]) (String a)) (A.concat gx (A.concat gy k)))
