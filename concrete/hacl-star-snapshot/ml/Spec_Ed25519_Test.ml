open Prims
let (test1_sk : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
    ...
    FStar_UInt8.uint_to_t (Prims.of_int (0x60))]
let (test1_pk : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
...
let (test1_msg : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x) []
let (test1_expected_sig : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
...
let (test2_sk : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
...
let (test2_pk : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
...
let (test2_msg : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
    [FStar_UInt8.uint_to_t (Prims.of_int (0x72))]
let (test2_expected_sig : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
    [FStar_UInt8.uint_to_t (Prims.of_int (0x92));
    ...
    FStar_UInt8.uint_to_t (Prims.of_int (0x0c));
    FStar_UInt8.uint_to_t Prims.int_zero]
let (test3_sk : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
    [FStar_UInt8.uint_to_t (Prims.of_int (0xc5));
    ...
    FStar_UInt8.uint_to_t (Prims.of_int (0xf7))]
let (test3_pk : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
...
let (test3_msg : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
    [FStar_UInt8.uint_to_t (Prims.of_int (0xaf));
    FStar_UInt8.uint_to_t (Prims.of_int (0x82))]
let (test3_expected_sig : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
    [FStar_UInt8.uint_to_t (Prims.of_int (0x62));
    FStar_UInt8.uint_to_t (Prims.of_int (0x91));
    ...
    FStar_UInt8.uint_to_t (Prims.of_int (0xc4));
    FStar_UInt8.uint_to_t (Prims.of_int (0x0a))]
let (test4_sk : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
    [FStar_UInt8.uint_to_t (Prims.of_int (0xf5));
    FStar_UInt8.uint_to_t (Prims.of_int (0xe5));
    FStar_UInt8.uint_to_t (Prims.of_int (0x76));
    ...
    FStar_UInt8.uint_to_t (Prims.of_int (0x0e));
    FStar_UInt8.uint_to_t (Prims.of_int (0xe5))]
let (test4_pk : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
    [FStar_UInt8.uint_to_t (Prims.of_int (0x27));
    FStar_UInt8.uint_to_t (Prims.of_int (0x81));
    FStar_UInt8.uint_to_t (Prims.of_int (0x17));
...
let (test4_msg : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
    ...
    FStar_UInt8.uint_to_t (Prims.of_int (0xb9));
    FStar_UInt8.uint_to_t (Prims.of_int (0xd0))]
let (test4_expected_sig : FStar_UInt8.t Prims.list) =
  FStar_List_Tot_Base.map (fun x -> x)
    [FStar_UInt8.uint_to_t (Prims.of_int (0x0a));
    FStar_UInt8.uint_to_t (Prims.of_int (0xab));
    FStar_UInt8.uint_to_t (Prims.of_int (0x4c));
...
let (test_ed25519 :
  ...
  fun sk ->
    fun pk ->
      fun msg ->
        fun expected_sig ->
          let sk_len = Obj.magic (FStar_List_Tot_Base.length sk) in
          let sk1 = Lib_Sequence.of_list sk in
          let pk_len = Obj.magic (FStar_List_Tot_Base.length pk) in
          let pk1 = Lib_Sequence.of_list pk in
          let msg_len = Obj.magic (FStar_List_Tot_Base.length msg) in
          let msg1 = Lib_Sequence.of_list msg in
          let expected_sig_len =
            Obj.magic (FStar_List_Tot_Base.length expected_sig) in
          let expected_sig1 = Lib_Sequence.of_list expected_sig in
          let sig1 = Spec_Ed25519.sign sk1 msg1 in
          let verify = Spec_Ed25519.verify pk1 msg1 sig1 in
          FStar_IO.print_string "\nExpected Ed25519 signature: ";
          FStar_List.iter
            (fun a -> FStar_IO.print_string (FStar_UInt8.to_string a))
            (Lib_Sequence.to_list expected_sig1);
          FStar_IO.print_string "\nComputed Ed25519 signature: ";
          FStar_List.iter
            (fun a -> FStar_IO.print_string (FStar_UInt8.to_string a))
            (Lib_Sequence.to_list sig1);
          (let res =
             Lib_Sequence.for_all2 (Obj.magic expected_sig_len)
               (fun a ->
                  fun b ->
                    (Lib_IntTypes.v Lib_IntTypes.U8 Lib_IntTypes.SEC
                      ...
                      =
                      (Lib_IntTypes.v Lib_IntTypes.U8 Lib_IntTypes.SEC
                         (Obj.magic b))) expected_sig1 sig1 in
           if res
           then FStar_IO.print_string "\nTest signature: Success!\n"
           else FStar_IO.print_string "\nTest signature: Failure :(\n";
           if verify
           then FStar_IO.print_string "Test verification: Success!\n"
           else FStar_IO.print_string "Test verification: Failure :(\n";
           res && verify)
    ...
    (let res1 = test_ed25519 test1_sk test1_pk test1_msg test1_expected_sig in
     ...
     (let res2 = test_ed25519 test2_sk test2_pk test2_msg test2_expected_sig in
      ...
      (let res3 = test_ed25519 test3_sk test3_pk test3_msg test3_expected_sig in
       FStar_IO.print_string "\nTEST 4\n";
       (let res4 =
          test_ed25519 test4_sk test4_pk test4_msg test4_expected_sig in
