  ...
  fun round ->
    fun rcon ->
      Vale_X64_Machine_s.Block
        ...
        Vale_X64_InsVector.va_code_VPslldq4 (Prims.of_int (3)) Prims.int_one;
        Vale_X64_InsVector.va_code_Pxor Prims.int_one (Prims.of_int (3));
        Vale_X64_InsVector.va_code_VPslldq4 (Prims.of_int (3)) Prims.int_one;
        Vale_X64_InsVector.va_code_Pxor Prims.int_one (Prims.of_int (3));
        Vale_X64_InsVector.va_code_VPslldq4 (Prims.of_int (3)) Prims.int_one;
        Vale_X64_InsVector.va_code_Pxor Prims.int_one (Prims.of_int (3));
...
let (va_codegen_success_KeyExpansionRound :
    ...
    fun rcon ->
      Vale_X64_Decls.va_pbool_and
        (Vale_X64_InsAes.va_codegen_success_AESNI_keygen_assist
           (Prims.of_int (2)) Prims.int_one rcon)
        (Vale_X64_Decls.va_pbool_and
...
let rec (va_code_KeyExpansionRoundUnrolledRecursive :
  ...
  fun n ->
    Vale_X64_Machine_s.Block
      [if (Prims.int_zero < n) && (n <= (Prims.of_int (10)))
       then
         Vale_X64_Machine_s.Block
  ...
  fun n ->
    Vale_X64_Decls.va_pbool_and
      (if (Prims.int_zero < n) && (n <= (Prims.of_int (10)))
       then
         Vale_X64_Decls.va_pbool_and
           (va_codegen_success_KeyExpansionRoundUnrolledRecursive
              (n - Prims.int_one))
           (Vale_X64_Decls.va_pbool_and
...
let (va_codegen_success_AES128EncryptRound :
  ...
  fun uu___ ->
    Vale_X64_Machine_s.Block
      ...
      Vale_X64_InsAes.va_code_AESNI_enc_last Prims.int_zero
        (Prims.of_int (2));
      Vale_X64_InsVector.va_code_Pxor (Prims.of_int (2)) (Prims.of_int (2))]
let (va_codegen_success_AES128EncryptBlock : unit -> Vale_X64_Decls.va_pbool)
  =
  fun uu___ ->
    Vale_X64_Decls.va_pbool_and
      (Vale_X64_InsVector.va_codegen_success_Load128_buffer Prims.int_zero
      ...
      (Vale_X64_Decls.va_pbool_and
         (Vale_X64_InsVector.va_codegen_success_Pxor Prims.int_zero
            (Prims.of_int (2)))
         (Vale_X64_Decls.va_pbool_and
            (va_codegen_success_AES128EncryptRound Prims.int_one)
            (Vale_X64_Decls.va_pbool_and
               (va_codegen_success_AES128EncryptRound (Prims.of_int (2)))
               (Vale_X64_Decls.va_pbool_and
                  (va_codegen_success_AES128EncryptRound (Prims.of_int (3)))
                  (Vale_X64_Decls.va_pbool_and
         ...
         Vale_X64_Decls.va_pbool_and
           ...
           (Vale_X64_Decls.va_pbool_and
              (Vale_X64_InsBasic.va_codegen_success_Mov64
                 ...
                 (Vale_X64_Machine_s.OReg (Prims.of_int (3))))
              (Vale_X64_Decls.va_ttrue ())))
      (Vale_X64_Decls.va_pbool_and (va_codegen_success_AES128EncryptBlock ())
         (Vale_X64_Decls.va_pbool_and
            (if win
             then
               Vale_X64_Decls.va_pbool_and
