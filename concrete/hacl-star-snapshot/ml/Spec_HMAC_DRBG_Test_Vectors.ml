...
type vec =
  ...
  entropy_input_reseed: Prims.string ;
  additional_input_reseed: Prims.string ;
...
let (__proj__Mkvec__item__a : vec -> Spec_Hash_Definitions.hash_alg) =
  fun projectee ->
    ...
    | { a; entropy_input; nonce; personalization_string;
        ...
        additional_input_2; returned_bits;_} -> a
let (__proj__Mkvec__item__entropy_input : vec -> Prims.string) =
  fun projectee ->
    match projectee with
    | { a; entropy_input; nonce; personalization_string;
        entropy_input_reseed; additional_input_reseed; additional_input_1;
        additional_input_2; returned_bits;_} -> entropy_input
let (__proj__Mkvec__item__nonce : vec -> Prims.string) =
  fun projectee ->
    match projectee with
    | { a; entropy_input; nonce; personalization_string;
        entropy_input_reseed; additional_input_reseed; additional_input_1;
        additional_input_2; returned_bits;_} -> nonce
let (__proj__Mkvec__item__personalization_string : vec -> Prims.string) =
  fun projectee ->
    match projectee with
    | { a; entropy_input; nonce; personalization_string;
        entropy_input_reseed; additional_input_reseed; additional_input_1;
        additional_input_2; returned_bits;_} -> personalization_string
let (__proj__Mkvec__item__entropy_input_reseed : vec -> Prims.string) =
  fun projectee ->
    match projectee with
    | { a; entropy_input; nonce; personalization_string;
        entropy_input_reseed; additional_input_reseed; additional_input_1;
        additional_input_2; returned_bits;_} -> entropy_input_reseed
let (__proj__Mkvec__item__additional_input_reseed : vec -> Prims.string) =
  fun projectee ->
    match projectee with
    | { a; entropy_input; nonce; personalization_string;
        entropy_input_reseed; additional_input_reseed; additional_input_1;
        additional_input_2; returned_bits;_} -> additional_input_reseed
let (__proj__Mkvec__item__additional_input_1 : vec -> Prims.string) =
  fun projectee ->
    match projectee with
    | { a; entropy_input; nonce; personalization_string;
        entropy_input_reseed; additional_input_reseed; additional_input_1;
        additional_input_2; returned_bits;_} -> additional_input_1
let (__proj__Mkvec__item__additional_input_2 : vec -> Prims.string) =
  fun projectee ->
    match projectee with
    | { a; entropy_input; nonce; personalization_string;
        entropy_input_reseed; additional_input_reseed; additional_input_1;
        additional_input_2; returned_bits;_} -> additional_input_2
let (__proj__Mkvec__item__returned_bits : vec -> Prims.string) =
  fun projectee ->
    match projectee with
    | { a; entropy_input; nonce; personalization_string;
        entropy_input_reseed; additional_input_reseed; additional_input_1;
        additional_input_2; returned_bits;_} -> returned_bits
let (test_vectors : vec Prims.list) =
  [{
     a = Spec_Hash_Definitions.SHA1;
  ...
  {
    a = Spec_Hash_Definitions.SHA2_256;
    entropy_input =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_256;
    entropy_input =
      "10b8789cdbd6778442a45edf228b9923f452631ad0fe9e608d10826ba71da7ca";
    nonce = "159fc5d8e50eb56e22974789b1dc20d1";
    personalization_string =
      "2dd59e37766c667571b779c06e12ba219188489772f48631a6728b5b867e3cf4";
    entropy_input_reseed =
      "966d942038030509b20e610062042b6bf104812818893292a68d57d1ce865151";
    additional_input_reseed = "";
    additional_input_1 = "";
    additional_input_2 = "";
    returned_bits =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_256;
    entropy_input =
      "e5fa73bed99340c91ab17d039efd248fcd1ab8b0a0f655dd3149949685ecadbd";
    nonce = "af4b94f08300a1eb059ad6a687a22fd1";
    personalization_string =
      "d0095a4fd7f6d6de2a1f0b292c47ece8565bf8c202f0723d0de7f2f7904537bf";
    entropy_input_reseed =
      "4dd81fad534aa36e174d06666e95a4d9b3622bf60d8a562c764541ea7c974fe9";
    additional_input_reseed =
      "117ca0aa9d57973005fad1f8a02f2d62ac701758556b42a8d5382ee55540a86b";
    additional_input_1 =
      "a36ba41e095a40f37985a5cd7315f3773132f491ef8a453d3970ae72f41c5365";
    additional_input_2 =
      "abba1d162556eaab729252cd48dead2d7d50a6385b1d270591d465fa38c5597d";
    returned_bits =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_256;
    entropy_input =
      "0c2c24287f264c1d5329d18989e7f9ce06b8a9446d26cd90ed718792b13dad94";
    nonce = "fd01d038386b37709f8da03579f82bcc";
    personalization_string = "";
    entropy_input_reseed =
      "05b523ccf880bfb0da83a05e4eb2ea28cc75a1e4f9e09c8a3959b18622453bdc";
    additional_input_reseed =
      "85e06a8ca3a741821c3a2a8818131675136efd5841cb96e7ddec7943cc169fa3";
    additional_input_1 =
      "6b842e1cfdcc6203fa3750cfb3c722f7a85014c06e78da8ea61f0f9e7c20cb4a";
    additional_input_2 =
      "7ba4a1494a0b498388f94d1726b8baf63e44a03c2bfbbff35ad039b39881720a";
    returned_bits =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_256;
    entropy_input =
      "c13d6cd63bb7931174696f3e04a0c41cb0b2561134e847ce03e36326b803f8ab";
    nonce = "2084ab32374392ea9f6e8a474f18e9d7";
    personalization_string = "";
    entropy_input_reseed =
      "aec5a6a7232a52b81ce7e981a359cef1bbd2f1eff8488371468cd1f4147a89c2";
    additional_input_reseed = "";
    additional_input_1 = "";
    additional_input_2 = "";
    returned_bits =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_256;
    entropy_input =
      "88a76c16d3270ed3fcd176f9d793fa0c35516574c1cef425b6007628afa35e2b";
    nonce = "ff16cf7cb8e49d482cfd3994abc5ef8a";
    personalization_string =
      "9213c54e3d002df8741163ab9d7e0757cd512c691ad64bafef95cb72539b0ac6";
    entropy_input_reseed =
      "493b647ff0b3faa2921f12f8f57b919329f2af2fc1f14576d9df2f8cc2ada7a6";
    additional_input_reseed = "";
    additional_input_1 = "";
    additional_input_2 = "";
    returned_bits =
  ...
  {
    a = Spec_Hash_Definitions.SHA2_384;
    entropy_input =
      "e8e99ffcf08aad8e50386f5d079d79d3db783a74165c6126b42b3140f744a7c7";
    nonce = "23541930c8c772adb62981dbef8d054e";
    personalization_string = "";
    entropy_input_reseed =
      "cdcf1c30228904bd7ba31798bfbbd64757aa251ac9a1ae8c20a050670feac59b";
    additional_input_reseed =
      "546e04247d6cb5212a57b62f99e1cca767a5768cf79296f45f0db24732ba6368";
    additional_input_1 =
      "fd45f66c8dede41387373c38674605f3e075c9b7cfc66123a5478b8f8e3ab276";
    additional_input_2 =
      "39911a79c6edbbc805a50d2aa018742094177a8e216d647c64428c00169ab2d6";
    returned_bits =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_384;
    entropy_input =
      "9319148fb7c2389793e9f53cd3b4ad8f1bb75710088f1c9a18434ce13b190da2";
    nonce = "11fdc53c13aea33985ba2678e8d86d09";
    personalization_string = "";
    entropy_input_reseed =
      "8619290e975f1c50f6606c7027efe9c8438d3209db71edd023af0eb024a282d2";
    additional_input_reseed = "";
    additional_input_1 = "";
    additional_input_2 = "";
    returned_bits =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_384;
    entropy_input =
      "f9e25060675e4c5734d818d9c31a0b232474520577e42f8c53f803aee2349f4a";
    nonce = "9a62a41cf3f5a9e198dff8c907a35a3f";
    personalization_string = "";
    entropy_input_reseed =
      "888a7529909ae36053c75badb44d103118e171784a7b67dc0d7a4e1b1d44391a";
    additional_input_reseed =
      "10a25d0027b1c55f615d3b7c3f235d791a81dfe8215315e0c38fccde27a5d8da";
    additional_input_1 =
      "7b10e25044abd0917490e7f1a8cfd24966803fc9be260f3ab5bf954693f60885";
    additional_input_2 =
      "a3563ec5c089fff127b2a2eaef12bd0cb3b18f3a0999754666113a052fd443f9";
    returned_bits =
  ...
  {
    a = Spec_Hash_Definitions.SHA2_512;
    entropy_input =
      "58ebcec4539f4af1b32a854181dd0f512b8c704fa47537096a769eff28c59165";
    nonce = "a18226cfc779efc9550f7be02006d83c";
    personalization_string = "";
    entropy_input_reseed =
      "230cd6e6909e301d1e99ecd1fff2b2cd00a56c7a684c8907bbb13ce3e9a0cbce";
    additional_input_reseed = "";
    additional_input_1 = "";
    additional_input_2 = "";
    returned_bits =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_512;
    entropy_input =
      "e1d2d72e7907e7214cb266f1ef641395e54b39e8365304661b0bee371f324652";
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_512;
    entropy_input =
      "47c42df62b4dd570efd3c2722ad39a2df5f969a13f645fd27b5290877ba70916";
    nonce = "c591934d4f66000ebf8c508fafc44f75";
    personalization_string =
      "94822903cb5c2003c31c6d072ab0dda435add0de7d8f9d5f08b5cba410d888fd";
    entropy_input_reseed =
      "d16a2c72c63580b9bcf156862214533a47b1686c871a0165604fdd00a412a484";
    additional_input_reseed = "";
    additional_input_1 = "";
    additional_input_2 = "";
    returned_bits =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_512;
    entropy_input =
      "f840c75ce0cdb200a3bd980d6cedf1c7321e5f303cd0446c7afd2d2d66657447";
    nonce = "b215333b15d55326bc9bebae6ae36efe";
    personalization_string =
      "6d5ca4b1edf6c0afbdce02ecb30923b2f4f2b33121e21b2ffee964cc7de1abe8";
    entropy_input_reseed =
      "a3a337c6fbeb6a979a4783f2b7f0f0dd6d3a9d3747de639a9047248a04a19f5b";
    additional_input_reseed =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_512;
    entropy_input =
      "46dfb4e82fc784ad0094dc81136834e5abc767fff2b876a06b1dbd2508dbed3a";
    nonce = "64d40d3886ac152838f6853121fd68b7";
    personalization_string = "";
    entropy_input_reseed =
      "329004b8bb439305c4b2dcdd54ca97a4f54cb720a8582cdc03ac26f8a603f3fd";
    additional_input_reseed = "";
    additional_input_1 = "";
    additional_input_2 = "";
    returned_bits =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_512;
    entropy_input =
      "12738c0ddd0c9ce0393d2acabdfa592286072a362e332ca3f8c401f01d610026";
    nonce = "b983dcfd4af5e451f6efe155fcf3ec14";
    personalization_string = "";
    entropy_input_reseed =
      "07c8b69898caec3a1104e2e30b811ea095384cc636b9bd24e0f9837d3b8e0b4c";
    additional_input_reseed =
      "fee06814eab6e55cb799e815d84f07278ec6c12d82dea12e261c5b72d0a4eaa5";
    additional_input_1 =
      "f29287d46d517f090df11af46703d5de778028c787a3aa1e5904ed737b776912";
    additional_input_2 =
      "0ce576cae56c46042ff27f9f11ed88f1ba534cf5f2581e5ad6bb69b642897886";
    returned_bits =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_512;
    entropy_input =
      "6a2baf90d2e8b83355a0230a8fc7237c140f7699f40026e276deaefd4faa8e06";
    nonce = "b2eecce638bd9fa485e9c9e0d94c3a78";
    personalization_string =
      "a9ea2c4b2aba1f48f2c71ae1a7fee90e073912c833f2de9c5f802ac2ddc57fbd";
    entropy_input_reseed =
      "820fc963827166de710208a7dc33936471e491fc21fb0119a252b49fefb28a01";
    additional_input_reseed =
      "9a463484d172108807c43c048bd13a72d15b470c3443390774a55572d03f47b1";
    additional_input_1 =
      "d98671978ae14b3531394a0785f78242d4b32eb61cffec6088efb8625693276a";
    additional_input_2 =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_512;
    entropy_input =
      "47139f544af9f6b0b8022bbae5b936a3f4bf8a0f1cd10c8c5fb8bb7363df6411";
    nonce = "b99640f70c7b55605f7bee6753f30675";
    personalization_string =
      "0f88357519e8f2c05495c595056e6023460bea47e79f72b113784eb6a77f9f28";
    entropy_input_reseed =
      "83ed7fb5ae85138161fe90b14b15295b11d81b0ecbd9f1838a2858cf9e822886";
    additional_input_reseed =
      "e973ea2d399b9c4ad685411a619b7a5ce6f6568bc66efb8855a69f256829a62d";
    additional_input_1 =
      "1bd8090104b78844f6d615e93b7ae0c921517c97735c0aaa28cdee1eb0a14659";
    additional_input_2 =
      "4d57d04fc0a2adc6ebb618f1236fee0eb00e38ff82137f5e375be00ad1aac35e";
    returned_bits =
  ...
  };
  {
    a = Spec_Hash_Definitions.SHA2_512;
    entropy_input =
      "2886ff4e11950c1e639398b2c7d6908d5c2e4daeb7719e6dd98a39b1428ea7df";
    nonce = "8cbb97f58cf243045bdadb2f9bbdab10";
    personalization_string = "";
    entropy_input_reseed =
      "f487b94b5e4eda49e933e0c268eb5042c422df88061ebffd893d39fafd58efd3";
    additional_input_reseed =
      "ff8e7656a21bcced082972719ebf87539c4825cb0f4beabd12a12d544dea87af";
    additional_input_1 =
      "f64dd3b0efc5c8c146f9b9b8f0ec7ccb784e87c16268a4aab31e9eddf2c9b83e";
    additional_input_2 =
      "9dc16b955ae805f10ebbdc3794a2abe671a339ca148b46ef6ea208698a54a0d8";
    returned_bits =
